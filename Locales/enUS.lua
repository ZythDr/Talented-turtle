...
L["Use Inspect tab"] = true
L["Use a tab-like Talented control on the default InspectFrame instead of a button."] = true
L["Icon offset"] = true
...
L["Target: %s"] = true
L["Target must be at least level 10 to have talents."] = true
